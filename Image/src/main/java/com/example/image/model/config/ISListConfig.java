...
/**
 * @author liwanlian
 * @date 2023/5/29 23:26
 */
public class ISListConfig implements Serializable {
    public boolean isChinese;//当前的语种环境
    /**
     * 是否需要裁剪
     */
    ...
    public ISListConfig(Builder builder) {
        this.isChinese = builder.isChinese;
        ...
        this.isCompress = builder.compress;
    }
    ...
    public static class Builder implements Serializable {
        ...
        public Builder getNowLan(boolean isChinese) {
